...
# reading the data
data = pd.read_csv(r'C:/Users/zpatel6/Desktop/Code/Netflix-Subscriptions.csv')
print(data.head())
...
fig = go.Figure()
fig.add_trace(go.Scatter(x=data['Time Period'], y=data['Subscribers'],mode='lines', name='Subscribers',line=dict(color='green')))
fig.update_layout(title='Netflix Subscriptions Growth', xaxis_title='Date', yaxis_title='Netflix Subscriptions')
fig.show()
